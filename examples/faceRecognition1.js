...
const basePath = '../data/face-recognition/images';
...
const twoFacesImg = cv.imread(path.resolve(basePath, 'example.jpg'));
...
cv.imwrite( path.resolve(basePath, 'example1.jpg'), twoFacesImg);
